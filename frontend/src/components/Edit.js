...
class Edit extends Component {
  ...
  componentDidMount() {
    ...
    axios.get('/users/contacts/'+this.props.match.params.id+'?access_token='+access_token)
      .then(res => {
  ...
  console.log("simple test data----");
    ...
    axios.put('/users/contacts/'+this.props.match.params.id+'?access_token='+localStorage.getItem("access_token"), { name, address, city, postalCode, phone })
      .then((result) => {
